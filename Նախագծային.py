...
def hide_indicators():
    ...
    set_indicate.configure(fg_color='#c3c3c3')
...
def set_page():
    delate_pages()
    set_frame = ctk.CTkFrame(main_frame, fg_color="transparent")
...
def show_graph_info():
    ...
    btn1 = ctk.CTkButton(main_frame, text = 'show', fg_color = 'red', command = btn_click, corner_radius=32)
    btn1.place(relx = 0.05, rely = 0.85, relheight = 0.05, relwidth = 0.1)
    btn2 = ctk.CTkButton(main_frame, text = 'delete', fg_color = 'red', command = btn_delete, corner_radius=32)
...
def show_mathnax_info():
    ...
    mathnax1_button = ctk.CTkButton(main_frame, text="Նախագծի անդամների պատասխանատվությանը", font=('Bold', 20), command=show_mathnax1_info, corner_radius=32)
    mathnax1_button.place(x=100, y=300)
    mathnax2_button = ctk.CTkButton(main_frame, text="Նախագծի Նպատակը", font=('Bold', 20), command=show_mathnax2_info, corner_radius=32)
    mathnax2_button.place(x=100, y=370)
    mathnax3_button = ctk.CTkButton(main_frame, text="Եզրակացություն", font=('Bold', 20), command=show_mathnax3_info, corner_radius=32)
...
def show_mathnax3_info():
    ...
    mathnax31_button = ctk.CTkButton(main_frame, text="Ինֆլ. և ավանդ", font=('Bold', 20), command=show_mathnax31_info, corner_radius=32)
    mathnax31_button.place(x=100, y=400)
    mathnax32_button = ctk.CTkButton(main_frame, text="Ինֆլ. և վարկեր(ոսկու գրավ)", font=('Bold', 20), command=show_mathnax32_info, corner_radius=32)
    mathnax32_button.place(x=100, y=470)
    mathnax33_button = ctk.CTkButton(main_frame, text="Ինֆլ. և վարկեր(տան գրավ)", font=('Bold', 20), command=show_mathnax33_info, corner_radius=32)
...
def show_pythonnax_info():
    ...
    python_button = ctk.CTkButton(main_frame, text="Python", font=('Bold', 20), command=show_python_info, corner_radius=32)
    python_button.place(x=100, y=300)
    math_button = ctk.CTkButton(main_frame, text="Մաթեմատիկա", font=('Bold', 20), command=show_math_info, corner_radius=32)
    math_button.place(x=100, y=370)
    graph_button = ctk.CTkButton(main_frame, text="Գրաֆիկների կառուցում", font=('Bold', 20), command=show_graph_info, corner_radius=32)
...
def show_python_info():
    ...
    python_label.pack(pady=100)
    show_Python_Concepts_for_Beginners_button = ctk.CTkButton(main_frame, text="Python-ի սկզբունքներ սկսնակների համար", font=('Bold', 20), command=show_Python_Concepts_for_Beginners, corner_radius=32)
...
def show_calculator_info():
    ...
    cal.geometry("410x500+100+200") 
    cal.resizable(False, False)
    cal.configure(fg_color="#171616")

    equation = ""
    label_result = ctk.CTkLabel(cal, width=25, height=2, text="", font=("Arial", 30), fg_color="#171616", text_color="white") 
    label_result.pack()
    ...
    for (text, command, x, y) in button_data:
        if text == "=": 
            ctk.CTkButton(cal, text=text, width=90, height=50, font=("Arial", 20, "bold"), border_width=2, text_color="#fff", fg_color="#FFA500", command=command).place(x=x, y=y)
        else:
            ctk.CTkButton(cal, text=text, width=90, height=50, font=("Arial", 20, "bold"), border_width=2, text_color="#fff", fg_color="#2a2d36", command=command).place(x=x, y=y)
    cal.mainloop()
...
def show_math_info():
    ...
    show_Math_10class_1Term_button = ctk.CTkButton(main_frame, text="Մաթեմատիկա 10-րդ դասարան 1-ին կիսամյակ", font=('Bold', 20), command=show_Math_10class_1Term, corner_radius=32)
    show_Math_10class_1Term_button.place(x=100, y=240)
    show_Math_10class_2Term_button = ctk.CTkButton(main_frame, text="Մաթեմատիկա 10-րդ դասարան 2-րդ կիսամյակ", font=('Bold', 20), command=show_Math_10class_2Term, corner_radius=32)
...
def show_Python_Concepts_for_Beginners():
    ...
    python_label.pack(pady=100)
    Input_and_Output_button = ctk.CTkButton(main_frame, text="Մուտք և Ելք", font=('Bold', 20), command=show_Input_and_Output_info, corner_radius=32)
    Input_and_Output_button.place(x=100, y=240)
    Variables_and_Types_button = ctk.CTkButton(main_frame, text="Փոփոխականներ և Տեսակներ", font=('Bold', 20), command=show_Variables_and_Types_info, corner_radius=32)
    Variables_and_Types_button.place(x=100, y=310)
    Conditional_Operators_button = ctk.CTkButton(main_frame, text="Պայմանների Օպերատորներ", font=('Bold', 20), command=show_Conditional_Operators_info, corner_radius=32)
    Conditional_Operators_button.place(x=100, y=380)
    String_button = ctk.CTkButton(main_frame, text="Տող", font=('Bold', 20), command=show_String_info, corner_radius=32)
    String_button.place(x=100, y=450)
    Lists_button = ctk.CTkButton(main_frame, text="Ցուցակներ", font=('Bold', 20), command=show_Lists_info, corner_radius=32)
...
def show_Python_Concepts_for_Mid_Level():
    ...
    python_label.pack(pady=100)
    List_Comprehension_button = ctk.CTkButton(main_frame, text="List Comprehension", font=('Bold', 20), command=show_List_Comprehension_info, corner_radius=32)
    List_Comprehension_button.place(x=100, y=240)
    Nested_Loops_button = ctk.CTkButton(main_frame, text="Ներդրված ցիկլեր", font=('Bold', 20), command=show_Nested_Loops_info, corner_radius=32)
    Nested_Loops_button.place(x=100, y=310)
    Dictionaries_button = ctk.CTkButton(main_frame, text="Dict", font=('Bold', 20), command=show_Dictionaries_info, corner_radius=32)
    Dictionaries_button.place(x=100, y=380)
    Functions_button = ctk.CTkButton(main_frame, text="Ֆունկցիաներ", font=('Bold', 20), command=show_Functions_info, corner_radius=32)
    Functions_button.place(x=100, y=450)
    Recursion_button = ctk.CTkButton(main_frame, text="Ռեկուրսիա", font=('Bold', 20), command=show_Recursion_info, corner_radius=32)
    Recursion_button.place(x=100, y=520)
    Tuples_and_Sets_button = ctk.CTkButton(main_frame, text="Tuple-ներ և Set-եր", font=('Bold', 20), command=show_Tuples_and_Sets_info, corner_radius=32)
...
def show_Math_10class_1Term():
    ...
    python_label.pack(pady=100)
    Real_Numbers_button = ctk.CTkButton(main_frame, text="Իրական թվեր", font=('Bold', 20), command=show_Real_Numbers, corner_radius=32)
...
def show_Math_10class_2Term():
    ...
    python_label.pack(pady=100)
    Function_button = ctk.CTkButton(main_frame, text="Ֆունկցիա", font=('Bold', 20), command=show_Function, corner_radius=32)
...
def show_Math_11class_1Term():
    ...
    python_label.pack(pady=100)
    Scalar_Functions_button = ctk.CTkButton(main_frame, text="Ցուցչային ֆունկցիաներ", font=('Bold', 20), command=show_Scalar_Function, corner_radius=32)
    Scalar_Functions_button.place(x=100, y=260)
    Pointar_Function_button = ctk.CTkButton(main_frame, text="Աստիճանային ֆունկցիաներ", font=('Bold', 20), command=show_Pointar_Function, corner_radius=32)
...
def show_Real_Numbers():
    ...
    Real_Numbers_Defiition_button = ctk.CTkButton(main_frame, text="Սահմանում", font=('Bold', 20), command=show_Real_Numbers_Defiition, corner_radius=32)
    Real_Numbers_Defiition_button.place(x=100, y=260)
    Real_Numbers_Types_button = ctk.CTkButton(main_frame, text="Տեսակներ", font=('Bold', 20), command=show_Real_Numbers_Types, corner_radius=32)
    Real_Numbers_Types_button.place(x=100, y=330)
    Real_Numbers_Properties_button = ctk.CTkButton(main_frame, text="Հատկություններ", font=('Bold', 20), command=show_Real_Numbers_Properties, corner_radius=32)
...
def show_Element_of_Trigonometry():
    ...
    Element_of_Trigonometry_Angels_button = ctk.CTkButton(main_frame, text="Անկյուններ", font=('Bold', 20), command=show_Element_of_Trigonometry_Angels, corner_radius=32)
    Element_of_Trigonometry_Angels_button.place(x=100, y=190)
    Element_of_Trigonometry_Triangle_button = ctk.CTkButton(main_frame, text="Ուղղանկյուն եռանկյան հետ կապ", font=('Bold', 20), command=show_Element_of_Trigonometry_Triangle, corner_radius=32)
    Element_of_Trigonometry_Triangle_button.place(x=100, y=260)
    Element_of_Trigonometry_Relation_button = ctk.CTkButton(main_frame, text="Հարաբերություններ", font=('Bold', 20), command=show_Element_of_Trigonometry_Relation, corner_radius=32)
    Element_of_Trigonometry_Relation_button.place(x=100, y=330)
    Element_of_Trigonometry_Circle_button = ctk.CTkButton(main_frame, text="Միավոր շրջան", font=('Bold', 20), command=show_Element_of_Trigonometry_Circle, corner_radius=32)
    Element_of_Trigonometry_Circle_button.place(x=100, y=400)
    Element_of_Trigonometry_Equation_button = ctk.CTkButton(main_frame, text="Ինքնահավասարություններ", font=('Bold', 20), command=show_Element_of_Trigonometry_Equation, corner_radius=32)
    Element_of_Trigonometry_Equation_button.place(x=100, y=470)
    Element_of_Trigonometry_Graph_button = ctk.CTkButton(main_frame, text="Ֆունկցիաների գրաֆիկներ", font=('Bold', 20), command=show_Element_of_Trigonometry_Graph, corner_radius=32)
...
def show_Function():
    ...
    Function_Bases_button = ctk.CTkButton(main_frame, text="Ֆունկցիաներ. Հիմունքներ", font=('Bold', 20), command=show_Function_Bases, corner_radius=32)
    Function_Bases_button.place(x=100, y=190)
    Function_Types_button = ctk.CTkButton(main_frame, text="Ֆունկցիաների տեսակները", font=('Bold', 20), command=show_Function_Types, corner_radius=32)
    Function_Types_button.place(x=100, y=260)
    Function_Properties_button = ctk.CTkButton(main_frame, text="Ֆունկցիաների հատկություններ", font=('Bold', 20), command=show_Function_Properties, corner_radius=32)
    Function_Properties_button.place(x=100, y=330)
    Function_Graph_button = ctk.CTkButton(main_frame, text="Ֆունկցիաների գրաֆիկներ", font=('Bold', 20), command=show_Function_Graph, corner_radius=32)
...
def show_Function_Bases():
    ...
    Function_Bases_Defination_button = ctk.CTkButton(main_frame, text="Սահմանում", font=('Bold', 20), command=show_Function_Bases_Defination, corner_radius=32)
    Function_Bases_Defination_button.place(x=100, y=190)
    Function_Bases_Presentation_button = ctk.CTkButton(main_frame, text="Ներկայացման եղանակներ", font=('Bold', 20), command=show_Function_Bases_Presentation, corner_radius=32)
...
def show_Function_Types():
    ...
    Function_Types_Expresion_button = ctk.CTkButton(main_frame, text="Ըստ արտահայտության", font=('Bold', 20), command=show_Function_Types_Expresion, corner_radius=32)
    Function_Types_Expresion_button.place(x=100, y=190)
    Function_Types_Relation_button = ctk.CTkButton(main_frame, text="Ըստ հարաբերության", font=('Bold', 20), command=show_Function_Types_Relation, corner_radius=32)
...
def show_Trigonometric_Functions_and_Equations():
    ...
    Trigonometric_Main_button = ctk.CTkButton(main_frame, text="Եռանկյունաչափության հիմնական գաղափարներ", font=('Bold', 20), command=show_Trigonometric_Main, corner_radius=32)
    Trigonometric_Main_button.place(x=60, y=260)
    Trigonometric_Relations_button = ctk.CTkButton(main_frame, text="Եռանկյունաչափական հարաբերություններ", font=('Bold', 20), command=show_Trigonometric_Relation, corner_radius=32)
    Trigonometric_Relations_button.place(x=60, y=330)
    Trigonometric_Similarity_button = ctk.CTkButton(main_frame, text="Եռանկյունաչափական նույնություններ", font=('Bold', 20), command=show_Trigonometric_Similarity, corner_radius=32)
    Trigonometric_Similarity_button.place(x=60, y=400)
    Trigonometric_Value_button = ctk.CTkButton(main_frame, text="Եռանկյունաչափական արժեքներ", font=('Bold', 20), command=show_Trigonometric_Value, corner_radius=32)
    Trigonometric_Value_button.place(x=60, y=470)
    Trigonometric_Equation_button = ctk.CTkButton(main_frame, text="Եռանկյունաչափական հավասարումներ", font=('Bold', 20), command=show_Trigonometric_Equation, corner_radius=32)
    Trigonometric_Equation_button.place(x=60, y=540)
    Trigonometric_Aplication_button = ctk.CTkButton(main_frame, text="Եռանկյունաչափության կիրառություններ", font=('Bold', 20), command=show_Trigonometric_Aplication, corner_radius=32)
...
def show_Scalar_Function():
    ...
    Scalar_Function_Main_button = ctk.CTkButton(main_frame, text="Ընդհանուր ձև", font=('Bold', 20), command=show_Scalar_Function_Main, corner_radius=32)
    Scalar_Function_Main_button.place(x=60, y=480)
    Scalar_Function_Properties_button = ctk.CTkButton(main_frame, text="Հիմնական հատկություններ", font=('Bold', 20), command=show_Scalar_Function_Properties, corner_radius=32)
    Scalar_Function_Properties_button.place(x=60, y=550)
    Scalar_Function_Diagrame_button = ctk.CTkButton(main_frame, text="Գծապատկերային առանձնահատկություններ", font=('Bold', 20), command=show_Scalar_Function_Diagrame, corner_radius=32)
...
def show_Pointar_Function():
    ...
    Pointar_Function_Main_button = ctk.CTkButton(main_frame, text="Ընդհանուր ձև", font=('Bold', 20), command=show_Pointar_Function_Main, corner_radius=32)
    Pointar_Function_Main_button.place(x=60, y=450)
    Pointar_Function_Properties_button = ctk.CTkButton(main_frame, text="Հիմնական հատկություններ", font=('Bold', 20), command=show_Pointar_Function_Properties, corner_radius=32)
    Pointar_Function_Properties_button.place(x=60, y=520)
    Pointar_Function_Diagrame_button = ctk.CTkButton(main_frame, text="Գծապատկերային առանձնահատկություններ", font=('Bold', 20), command=show_Pointar_Function_Diagrame, corner_radius=32)
    Pointar_Function_Diagrame_button.place(x=60, y=590)
    Pointar_Function_Case_button = ctk.CTkButton(main_frame, text="Հատուկ դեպքեր", font=('Bold', 20), command=show_Pointar_Function_Case, corner_radius=32)
...
def show_Log_Function():
    ...
    Log_Function_Main_button = ctk.CTkButton(main_frame, text="Լոգարիթմական ֆունկցիաների մուտք", font=('Bold', 20), command=show_Log_Function_Main, corner_radius=32)
    Log_Function_Main_button.place(x=60, y=200)
    Log_Function_Defination_button = ctk.CTkButton(main_frame, text="Լոգարիթմի սահմանում", font=('Bold', 20), command=show_Log_Function_Defination, corner_radius=32)
    Log_Function_Defination_button.place(x=60, y=270)
    Log_Function_Properties_button = ctk.CTkButton(main_frame, text="Լոգարիթմական հիմնական հատկությունները", font=('Bold', 20), command=show_Log_Function_Properties, corner_radius=32)
    Log_Function_Properties_button.place(x=60, y=340)
    Log_Function_Types_button = ctk.CTkButton(main_frame, text="Լոգարիթմի տեսակները", font=('Bold', 20), command=show_Log_Function_Types, corner_radius=32)
    Log_Function_Types_button.place(x=60, y=410)
    Log_Function_Graph_button = ctk.CTkButton(main_frame, text="Լոգարիթմական ֆունկցիաների գծերը", font=('Bold', 20), command=show_Log_Function_Graph, corner_radius=32)
    Log_Function_Graph_button.place(x=60, y=480)
    Log_Function_Solution_button = ctk.CTkButton(main_frame, text="Լոգարիթմական հավասարումների լուծում", font=('Bold', 20), command=show_Log_Function_Solution, corner_radius=32)
    Log_Function_Solution_button.place(x=60, y=550)
    Log_Function_Use_button = ctk.CTkButton(main_frame, text="Լոգարիթմների կիրառություններ", font=('Bold', 20), command=show_Log_Function_Use, corner_radius=32)
...
def show_Input_and_Output_info():
    ...
    Input_and_Outputn_Input_button = ctk.CTkButton(main_frame, text="Մուտք Python-ում", font=('Bold', 20), command=show_Input_and_Outputn_Input, corner_radius=32)
    Input_and_Outputn_Input_button.place(x=100, y=260)
    Input_and_Outputn_Output_button = ctk.CTkButton(main_frame, text="Ելք Python-ում", font=('Bold', 20), command=show_Input_and_Outputn_Output, corner_radius=32)
    Input_and_Outputn_Output_button.place(x=100, y=330)
    Input_and_Outputn_File_button = ctk.CTkButton(main_frame, text="Ֆայլերի Մուտք/Ելք(Հավելյալ)", font=('Bold', 20), command=show_Input_and_Outputn_File, corner_radius=32)
...
def show_Variables_and_Types_info():
    ...
    Variables_and_Types1_button = ctk.CTkButton(main_frame, text="Փոփոխականների Հայտարարում", font=('Bold', 20), command=show_Variables_and_Types1, corner_radius=32)
    Variables_and_Types1_button.place(x=100, y=260)
    Variables_and_Types2_button = ctk.CTkButton(main_frame, text="Փոփոխականների Անվանման Կանոններ", font=('Bold', 20), command=show_Variables_and_Types2, corner_radius=32)
    Variables_and_Types2_button.place(x=100, y=330)
    Variables_and_Types3_button = ctk.CTkButton(main_frame, text="Տվյալների Տիպեր Python-ում", font=('Bold', 20), command=show_Variables_and_Types3, corner_radius=32)
    Variables_and_Types3_button.place(x=100, y=400)
    Variables_and_Types4_button = ctk.CTkButton(main_frame, text="Դինամիկ Տիպավորում", font=('Bold', 20), command=show_Variables_and_Types4, corner_radius=32)
    Variables_and_Types4_button.place(x=100, y=470)
    Variables_and_Types5_button = ctk.CTkButton(main_frame, text="Տիպի Ստուգում", font=('Bold', 20), command=show_Variables_and_Types5, corner_radius=32)
    Variables_and_Types5_button.place(x=100, y=540)
    Variables_and_Types6_button = ctk.CTkButton(main_frame, text="Տիպերի Փոխակերպում", font=('Bold', 20), command=show_Variables_and_Types6, corner_radius=32)
    Variables_and_Types6_button.place(x=100, y=610)
    Variables_and_Types7_button = ctk.CTkButton(main_frame, text="Կարևոր Կետեր՝ Հիշելու Համար", font=('Bold', 20), command=show_Variables_and_Types7, corner_radius=32)
...
def show_Conditional_Operators_info():
    ...
    Conditional_Operators2_button = ctk.CTkButton(main_frame, text="Համակցված արտահայտություններում", font=('Bold', 20), command=show_Conditional_Operators2, corner_radius=32)
...
def show_String_info():
    ...
    String2_button = ctk.CTkButton(main_frame, text="Տողերի ստեղծում", font=('Bold', 20), command=show_String2, corner_radius=32)
    String2_button.place(x=100, y=370)
    String3_button = ctk.CTkButton(main_frame, text="Հիմնական գործողություններ տողերի հետ", font=('Bold', 20), command=show_String3, corner_radius=32)
    String3_button.place(x=100, y=440)
    String4_button = ctk.CTkButton(main_frame, text="Տողի մեթոդներ", font=('Bold', 20), command=show_String4, corner_radius=32)
    String4_button.place(x=100, y=510)
    String5_button = ctk.CTkButton(main_frame, text="Տողի ձևաչափում", font=('Bold', 20), command=show_String5, corner_radius=32)
    String5_button.place(x=100, y=580)
    String6_button = ctk.CTkButton(main_frame, text="Փախուստի սիմվոլներ", font=('Bold', 20), command=show_String6, corner_radius=32)
...
def show_Lists_info():
    ...
    Lists1_button = ctk.CTkButton(main_frame, text="Ի՞նչ է ցուցակը", font=('Bold', 20), command=show_List1, corner_radius=32)
    Lists1_button.place(x=80, y=170)
    Lists2_button = ctk.CTkButton(main_frame, text="Ցուցակի ստեղծում", font=('Bold', 20), command=show_List2, corner_radius=32)
    Lists2_button.place(x=80, y=240)
    Lists3_button = ctk.CTkButton(main_frame, text="Տարրերին մուտք գործել", font=('Bold', 20), command=show_List3, corner_radius=32)
    Lists3_button.place(x=80, y=310)
    Lists4_button = ctk.CTkButton(main_frame, text="Ցուցակի Փոփոխություն", font=('Bold', 20), command=show_List4, corner_radius=32)
    Lists4_button.place(x=80, y=380)
    Lists5_button = ctk.CTkButton(main_frame, text="Հաճախ կիրառվող գործողություններ ցուցակների համար", font=('Bold', 20), command=show_List5, corner_radius=32)
    Lists5_button.place(x=80, y=450)
    Lists6_button = ctk.CTkButton(main_frame, text="Ցիկլ ցուցակի վրա", font=('Bold', 20), command=show_List6, corner_radius=32)
    Lists6_button.place(x=80, y=520)
    Lists7_button = ctk.CTkButton(main_frame, text="Կտորում (Slicing)", font=('Bold', 20), command=show_List7, corner_radius=32)
    Lists7_button.place(x=80, y=590)
    Lists8_button = ctk.CTkButton(main_frame, text="Ցուցակի մեթոդներ", font=('Bold', 20), command=show_List8, corner_radius=32)
...
def show_Loops_info():
    ...
    Loops1_button = ctk.CTkButton(main_frame, text="for ցիկլ", font=('Bold', 20), command=show_Loops1, corner_radius=32)
    Loops1_button.place(x=100, y=200)
    Loops2_button = ctk.CTkButton(main_frame, text="while ցիկլ", font=('Bold', 20), command=show_Loops2, corner_radius=32)
    Loops2_button.place(x=100, y=270)
    Loops3_button = ctk.CTkButton(main_frame, text="Ցիկլերի կառավարման հրամաններ", font=('Bold', 20), command=show_Loops3, corner_radius=32)
    Loops3_button.place(x=100, y=340)
    Loops4_button = ctk.CTkButton(main_frame, text="Ներդրված(Nested) ցիկլեր", font=('Bold', 20), command=show_Loops4, corner_radius=32)
...
def show_List_Comprehension_info():
    ...
    List_Comprehension1_button = ctk.CTkButton(main_frame, text="Սինտաքս", font=('Bold', 20), command=show_List_Comprehension1, corner_radius=32)
    List_Comprehension1_button.place(x=100, y=580)
    List_Comprehension1_button = ctk.CTkButton(main_frame, text="Օրինակներ", font=('Bold', 20), command=show_List_Comprehension2, corner_radius=32)
...
def show_Nested_Loops_info():
    ...
    Nested_Loops1_button = ctk.CTkButton(main_frame, text="Սինտաքս", font=('Bold', 20), command=show_Nested_Loops1, corner_radius=32)
    Nested_Loops1_button.place(x=100, y=200)
    Nested_Loops2_button = ctk.CTkButton(main_frame, text="Հաճախակի կիրառություններ", font=('Bold', 20), command=show_Nested_Loops2, corner_radius=32)
    Nested_Loops2_button.place(x=100, y=270)
    Nested_Loops3_button = ctk.CTkButton(main_frame, text="Օրինակներ", font=('Bold', 20), command=show_Nested_Loops3, corner_radius=32)
...
def show_Dictionaries_info():
    ...
    Dictionaries1_button = ctk.CTkButton(main_frame, text="Հիմնական հատկանիշները", font=('Bold', 20), command=show_Dictionaries1, corner_radius=32)
    Dictionaries1_button.place(x=100, y=500)
    Dictionaries2_button = ctk.CTkButton(main_frame, text="Սինտաքսը", font=('Bold', 20), command=show_Dictionaries2, corner_radius=32)
    Dictionaries2_button.place(x=100, y=570)
    Dictionaries3_button = ctk.CTkButton(main_frame, text="Գործողությունները", font=('Bold', 20), command=show_Dictionaries3, corner_radius=32)
...
set_indicate = ctk.CTkLabel(options_frame, text="", fg_color="#c3c3c3", width=5, height=40)
set_indicate.place(x=3, y=150)

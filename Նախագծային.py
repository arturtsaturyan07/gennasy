...
def home_page():
    ...
    graph_button = ctk.CTkButton(
        main_frame,
        text="Գրաֆիկների կառուցում",
        font=("Bold", 20),
        command=show_graph_info,
        hover_color="#a3a3a3",
    )
    graph_button.place(x=150, y=440)
...
def show_mathnax3_info():
    delate_pages()
    mathnax_label = ctk.CTkLabel(main_frame, text="Եզրակացություն", font=('Bold', 35))
    mathnax_label.pack(pady=100)
    text_content = (
        "       Բազմաթիվ հաշվարկներից հետո ստացանք բանաձևեր\n"
        "կապված վարկերի, ավանդների և ինֆլյացիայի հետ։")
    mathnax1_text = ctk.CTkLabel(main_frame, text=text_content, font=('Bold', 20))
    mathnax1_text.place(x=10, y=250)
...
def show_mathnax34_info():
    delate_pages()
    mathnax_label = ctk.CTkLabel(main_frame, text="Ինֆլ. և վարկեր(սովորական)", font=('Bold', 35))
    mathnax_label.pack(pady=100)
    text_content = (
...
def show_mathnax33_info():
    delate_pages()
    mathnax_label = ctk.CTkLabel(main_frame, text="Ինֆլ. և վարկեր(տան գրավ)", font=('Bold', 35))
    mathnax_label.pack(pady=100)
    text_content = (
...
def show_mathnax32_info():
    delate_pages()
    mathnax_label = ctk.CTkLabel(main_frame, text="Ինֆլ. և վարկեր(ոսկու գրավ)", font=('Bold', 35))
    mathnax_label.pack(pady=100)
    text_content = (
...
def show_mathnax31_info():
    delate_pages()
    mathnax_label = ctk.CTkLabel(main_frame, text="Ինֆլ. և ավանդ", font=('Bold', 35))
    mathnax_label.pack(pady=100)
    text_content = (
...
def show_mathnax2_info():
    delate_pages()
    mathnax_label = ctk.CTkLabel(main_frame, text="Նախագծի Նպատակը", font=('Bold', 35))
    mathnax_label.pack(pady=100)
    text_content = (
...
def show_python_info():
    delate_pages()
    python_label = ctk.CTkLabel(main_frame, text="Python-ը հզոր լեզու է!", font=('Bold', 35))
    python_label.pack(pady=100)
...
def show_Python_Concepts_for_Mid_Level():
    delate_pages()
    python_label = ctk.CTkLabel(main_frame, text="   Python-ի սկզբունքներ\nմիջին մակարդակի համարը", font=('Bold', 35))
    python_label.pack(pady=100)
...
def show_Real_Numbers():
    delate_pages()
    Real_Numbers = ctk.CTkLabel(main_frame, text="Իրական թվեր", font=('Bold', 35))
...
def show_Real_Numbers_Defiition():
    delate_pages()
    show_Real_Numbers_Defiition = ctk.CTkLabel(main_frame, text="Իրական թվերի սահմանումը", font=('Bold', 35))
    ...
    real_numbers_text = ctk.CTkLabel(main_frame, text=text_content, font=('Bold', 20))
...
def show_Real_Numbers_Types():
    delate_pages()
    show_Real_Numbers_Defiition = ctk.CTkLabel(main_frame, text="Իրական թվերի տեսակները", font=('Bold', 35))
    show_Real_Numbers_Defiition.pack(pady=100)
    text_content = (
...
def show_Real_Numbers_Properties():
    delate_pages()
    show_Real_Numbers_Defiition = ctk.CTkLabel(main_frame, text="Իրական թվերի հատկությունները", font=('Bold', 35))
    show_Real_Numbers_Defiition.pack(pady=100)
    text_content = (
...
def show_Element_of_Trigonometry():
    delate_pages()
    Element_of_Trigonometry = ctk.CTkLabel(main_frame, text="Եռանկյունաչափության տարրերը", font=('Bold', 35))
...
def show_Element_of_Trigonometry_Angels():
    ...
    element_of_trigonometry_text = ctk.CTkLabel(main_frame, text=text_content, font=('Bold', 20))
...
def show_Element_of_Trigonometry_Triangle():
    delate_pages()
    Element_of_Trigonometry = ctk.CTkLabel(main_frame, text="Եռանկյունաչափության տարրերը:\nՈւղղանկյուն եռանկյան հետ կապը", font=('Bold', 35))
    Element_of_Trigonometry.pack(pady=100)
    text_content = (
...
def show_Element_of_Trigonometry_Relation():
    delate_pages()
    Element_of_Trigonometry = ctk.CTkLabel(main_frame, text="Եռանկյունաչափության տարրերը:\n      Հարաբերությունները", font=('Bold', 35))
    Element_of_Trigonometry.pack(pady=100)
    text_content = (
...
def show_Element_of_Trigonometry_Equation():
    delate_pages()
    Element_of_Trigonometry = ctk.CTkLabel(main_frame, text="Եռանկյունաչափության տարրերը:\n   Ինքնահավասարությունները", font=('Bold', 35))
    Element_of_Trigonometry.pack(pady=100)
    text_content = (
...
def show_Element_of_Trigonometry_Graph():
    delate_pages()
    Element_of_Trigonometry = ctk.CTkLabel(main_frame, text="Եռանկյունաչափության տարրերը:\n   Ֆունկցիաների գրաֆիկները", font=('Bold', 35))
    Element_of_Trigonometry.pack(pady=100)
    text_content = (
...
def show_Function():
    delate_pages()
    Function = ctk.CTkLabel(main_frame, text="Ֆունկցիա", font=('Bold', 35))
...
def show_Function_Bases():
    delate_pages()
    Function_Bases = ctk.CTkLabel(main_frame, text="Ֆունկցիաների տեսակները", font=('Bold', 35))
...
def show_Function_Types():
    delate_pages()
    Function_Types = ctk.CTkLabel(main_frame, text="Ֆունկցիաներ. Հիմունքներ", font=('Bold', 35))
...
def show_Function_Bases_Defination():
    delate_pages()
    Function_Bases = ctk.CTkLabel(main_frame, text="Սահմանում", font=('Bold', 35))
    Function_Bases.pack(pady=100)
    text_content = (
    ...
    Function_Bases_Defination_text = ctk.CTkLabel(main_frame, text=text_content, font=('Bold', 20))
...
def show_Function_Bases_Presentation():
    delate_pages()
    Function_Bases = ctk.CTkLabel(main_frame, text="Ներկայացման եղանակներ", font=('Bold', 35))
    Function_Bases.pack(pady=100)
    text_content = (
        "\n       Բանաձևային՝ f(x) = y։\n"
    ...
    Function_Bases_Presentation_text = ctk.CTkLabel(main_frame, text=text_content, font=('Bold', 20))
...
def show_Function_Bases_Termins():
    delate_pages()
    Function_Bases = ctk.CTkLabel(main_frame, text="Տերմիններ", font=('Bold', 35))
    Function_Bases.pack(pady=100)
    text_content = (
    ...
    Function_Bases_Termins_text = ctk.CTkLabel(main_frame, text=text_content, font=('Bold', 20))
...
def show_Function_Types_Expresion():
    delate_pages()
    Function_Types = ctk.CTkLabel(main_frame, text="Ըստ արտահայտության", font=('Bold', 35))
    Function_Types.pack(pady=100)
    text_content = (
    ...
    Function_Types_Expresion_text = ctk.CTkLabel(main_frame, text=text_content, font=('Bold', 20))
...
def show_Function_Types_Relation():
    delate_pages()
    Function_Types = ctk.CTkLabel(main_frame, text="Ըստ հարաբերության", font=('Bold', 35))
    Function_Types.pack(pady=100)
    text_content = (
    ...
    Function_Types_Relation_text = ctk.CTkLabel(main_frame, text=text_content, font=('Bold', 20))
...
def show_Function_Types_Typic():
    delate_pages()
    Function_Types = ctk.CTkLabel(main_frame, text="Հատուկ ֆունկցիաներ։", font=('Bold', 35))
    Function_Types.pack(pady=100)
    text_content = (
        ...
        "f(x) = a^x, log(x)։\n")
    Function_Types_Typic_text = ctk.CTkLabel(main_frame, text=text_content, font=('Bold', 20))
...
def show_Function_Properties():
    delate_pages()
    Function_Types = ctk.CTkLabel(main_frame, text="Ֆունկցիաների հատկություններ։", font=('Bold', 35))
    Function_Types.pack(pady=100)
    text_content = (
        "\n       Մեկից-մեկ (Injective)։\n"
...
def show_Function_Graph():
    delate_pages()
    Function_Types = ctk.CTkLabel(main_frame, text="Ֆունկցիաների գրաֆիկներ։", font=('Bold', 35))
    Function_Types.pack(pady=100)
    text_content = (
...
def show_Function_Aplication():
    delate_pages()
    Function_Types = ctk.CTkLabel(main_frame, text="Ֆունկցիաների կիրառություններ։", font=('Bold', 35))
    Function_Types.pack(pady=100)
    text_content = (
...
def show_Trigonometric_Main():
    ...
    Trigonometric_text = ctk.CTkLabel(main_frame, text=text_content, font=('Bold', 20))
...
def show_Trigonometric_Circle():
    delate_pages()
    Function_Types = ctk.CTkLabel(main_frame, text="Միավոր շրջանը։", font=('Bold', 35))
    Function_Types.pack(pady=100)
    text_content = (
...
def show_Scalar_Function():
    delate_pages()
    Scalar_Function = ctk.CTkLabel(main_frame, text="Ցուցչային ֆունկցիաներ", font=('Bold', 35))
    ...
    Scalar_Function_text = ctk.CTkLabel(main_frame, text=text_content, font=('Bold', 20))
...
def show_Scalar_Function_Use():
    delate_pages()
    Scalar_Function = ctk.CTkLabel(main_frame, text="Օգտագործումներ", font=('Bold', 35))
    Scalar_Function.pack(pady=100)
    text_content = (
...
def show_Scalar_Function_Properties():
    delate_pages()
    Scalar_Function = ctk.CTkLabel(main_frame, text="Հիմնական հատկություններ", font=('Bold', 35))
    Scalar_Function.pack(pady=100)
    text_content = (
...
def show_Scalar_Function_Main():
    delate_pages()
    Scalar_Function = ctk.CTkLabel(main_frame, text="Ընդհանուր ձև", font=('Bold', 35))
    Scalar_Function.pack(pady=100)
    text_content = (
        "\n       𝑓(𝑥) = 𝑎 ⋅ 𝑏^𝑥\n\n"
...
def show_Pointar_Function():
    delate_pages()
    Pointar_Function = ctk.CTkLabel(main_frame, text="Աստիճանային ֆունկցիաներ", font=('Bold', 35))
    ...
    text_content = (
        ...
        "Այս ֆունկցիաներն լայնորեն օգտագործվում են աճի և անկման\n"
        "խնդիրներում, ֆինանսներում և բնական երևույթներում։\n") 
    Pointar_Function_text = ctk.CTkLabel(main_frame, text=text_content, font=('Bold', 20))
...
def show_Pointar_Function_Use():
    delate_pages()
    Pointar_Function = ctk.CTkLabel(main_frame, text="Օգտագործումներ", font=('Bold', 35))
    Pointar_Function.pack(pady=100)
    text_content = (
...
def show_Pointar_Function_Case():
    delate_pages()
    Pointar_Function = ctk.CTkLabel(main_frame, text="Հատուկ դեպքեր", font=('Bold', 35))
    Pointar_Function.pack(pady=100)
    text_content = (
...
def show_Pointar_Function_Properties():
    delate_pages()
    Pointar_Function = ctk.CTkLabel(main_frame, text="Հիմնական հատկություններ", font=('Bold', 35))
    Pointar_Function.pack(pady=100)
    text_content = (
        "\n      Տարածք:\n"
...
def show_Pointar_Function_Main():
    delate_pages()
    Pointar_Function = ctk.CTkLabel(main_frame, text="Ընդհանուր ձև", font=('Bold', 35))
    Pointar_Function.pack(pady=100)
    text_content = (
        "\n       𝑓(𝑥) = 𝑎𝑥ⁿ\n"
...
def show_Log_Function():
    delate_pages()
    Log_Function = ctk.CTkLabel(main_frame, text="Լոգարիթմական ֆունկցիաներ", font=('Bold', 35))
...
def show_Log_Function_Use():
    delate_pages()
    Scalar_Function = ctk.CTkLabel(main_frame, text="Լոգարիթմների կիրառություններ", font=('Bold', 35))
    Scalar_Function.pack(pady=100)
    text_content = (
...
def show_Log_Function_Graph():
    delate_pages()
    Scalar_Function = ctk.CTkLabel(main_frame, text="      Լոգարիթմական\n ֆունկցիաների գծերը", font=('Bold', 35))
    Scalar_Function.pack(pady=100)
    text_content = (
...
def show_Log_Function_Types():
    delate_pages()
    Scalar_Function = ctk.CTkLabel(main_frame, text="Լոգարիթմի տեսակները", font=('Bold', 35))
    Scalar_Function.pack(pady=100)
    text_content = (
...
def show_Log_Function_Properties():
    delate_pages()
    Scalar_Function = ctk.CTkLabel(main_frame, text="   Լոգարիթմական\n հիմնական հատկությունները", font=('Bold', 35))
    Scalar_Function.pack(pady=100)
    text_content = (
...
def show_Log_Function_Defination():
    delate_pages()
    Scalar_Function = ctk.CTkLabel(main_frame, text="Լոգարիթմի սահմանում", font=('Bold', 35))
    Scalar_Function.pack(pady=100)
    text_content = (
...
def show_Log_Function_Main():
    delate_pages()
    Scalar_Function = ctk.CTkLabel(main_frame, text="  Լոգարիթմական\nֆունկցիաների մուտք", font=('Bold', 35))
    Scalar_Function.pack(pady=100)
    text_content = (
...
def show_Input_and_Output_info():
    delate_pages()
    Input_and_Outputn_label = ctk.CTkLabel(main_frame, text="Մուտք և Ելք", font=('Bold', 35))
...
def show_Input_and_Outputn_Important():
    delate_pages()
    Scalar_Function = ctk.CTkLabel(main_frame, text="Կարևոր կետեր՝ հիշելու համար", font=('Bold', 35))
    Scalar_Function.pack(pady=100)
    text_content = (
        "\n       Մուտք:\n"
...
def show_Input_and_Outputn_File():
    delate_pages()
    Scalar_Function = ctk.CTkLabel(main_frame, text="Ֆայլերի Մուտք/Ելք", font=('Bold', 35))
    Scalar_Function.pack(pady=100)
    text_content = (
...
def show_Input_and_Outputn_Output():
    delate_pages()
    Scalar_Function = ctk.CTkLabel(main_frame, text="Ելք Python-ում", font=('Bold', 35))
    Scalar_Function.pack(pady=100)
    text_content = (
...
def show_Input_and_Outputn_Input():
    delate_pages()
    Scalar_Function = ctk.CTkLabel(main_frame, text="Մուտք Python-ում", font=('Bold', 35))
    Scalar_Function.pack(pady=100)
    text_content = (
...
def show_Variables_and_Types_info():
    delate_pages()
    Variables_and_Types_label = ctk.CTkLabel(main_frame, text="Փոփոխականներ և Տեսակներ", font=('Bold', 35))
...
def show_Variables_and_Types1():
    delate_pages()
    Scalar_Function = ctk.CTkLabel(main_frame, text="Փոփոխականների Հայտարարում", font=('Bold', 35))
    Scalar_Function.pack(pady=100)
    text_content = (
...
def show_Variables_and_Types3():
    delate_pages()
    Scalar_Function = ctk.CTkLabel(main_frame, text="Տվյալների Տիպեր Python-ում", font=('Bold', 35))
    Scalar_Function.pack(pady=100)
    text_content = (
...
def show_Variables_and_Types4():
    delate_pages()
    Scalar_Function = ctk.CTkLabel(main_frame, text="Դինամիկ Տիպավորում", font=('Bold', 35))
    Scalar_Function.pack(pady=100)
    text_content = (
...
def show_Variables_and_Types5():
    delate_pages()
    Scalar_Function = ctk.CTkLabel(main_frame, text="Տիպի Ստուգում", font=('Bold', 35))
    Scalar_Function.pack(pady=100)
    text_content = (
...
def show_Variables_and_Types6():
    delate_pages()
    Scalar_Function = ctk.CTkLabel(main_frame, text="Տիպերի Փոխակերպում", font=('Bold', 35))
    Scalar_Function.pack(pady=100)
    text_content = (
        "\n       Տիպերի Փոխակերպում\n"
...
def show_Conditional_Operators_info():
    delate_pages()
    Conditional_Operators_label = ctk.CTkLabel(main_frame, text="Պայմանների Օպերատորներ", font=('Bold', 35))
    ...
    Conditional_Operators_text = ctk.CTkLabel(main_frame, text=text_content, font=('Bold', 20))
...
def show_Conditional_Operators1():
    ...
    text_content = (
        ...
        "5>=5                  True\n"
        "5<=3                  False") 
    Conditional_Operators1_text = ctk.CTkLabel(main_frame, text=text_content, font=('Bold', 20))
...
def show_String_info():
    delate_pages()
    String_label = ctk.CTkLabel(main_frame, text="Տող", font=('Bold', 35))
    ...
    text_content = (
        ...
        "մշակելու համար։")
    String_text = ctk.CTkLabel(main_frame, text=text_content, font=('Bold', 20))
...
def show_String6():
    delate_pages()
    Conditional_Operators1 = ctk.CTkLabel(main_frame, text="Փախուստի սիմվոլներ", font=('Bold', 35))
    Conditional_Operators1.pack(pady=100)
    text_content = (
        "       \\': Մեկ չակերտ։\n"
        "\\\": Կրկնակի չակերտ։\n"
...
def show_String5():
    delate_pages()
    Conditional_Operators1 = ctk.CTkLabel(main_frame, text="Տողի ձևաչափում", font=('Bold', 35))
    Conditional_Operators1.pack(pady=100)
    text_content = (
...
def show_String4():
    delate_pages()
    Conditional_Operators1 = ctk.CTkLabel(main_frame, text="Տողի մեթոդներ", font=('Bold', 35))
    Conditional_Operators1.pack(pady=100)
    text_content = (
...
def show_String2():
    delate_pages()
    Conditional_Operators1 = ctk.CTkLabel(main_frame, text="Տողերի ստեղծում", font=('Bold', 35))
    Conditional_Operators1.pack(pady=100)
    text_content = (
...
def show_String1():
    delate_pages()
    Conditional_Operators1 = ctk.CTkLabel(main_frame, text="Ի՞նչ է տողը", font=('Bold', 35))
    Conditional_Operators1.pack(pady=100)
    text_content = (
...
def show_Lists_info():
    delate_pages()
    Lists_label = ctk.CTkLabel(main_frame, text="Ցուցակներ", font=('Bold', 35))
...
def show_List9():
    delate_pages()
    List1 = ctk.CTkLabel(main_frame, text="Հիմնական հատկություններ", font=('Bold', 35))
    List1.pack(pady=100)
    text_content = (
        ...
        "matrix = [[1, 2, 3], [4, 5, 6]]\n") 
    List1_text = ctk.CTkLabel(main_frame, text=text_content, font=('Bold', 20))
...
def show_List8():
    delate_pages()
    List1 = ctk.CTkLabel(main_frame, text="Ցուցակի մեթոդներ", font=('Bold', 35))
    List1.pack(pady=100)
    text_content = (
...
def show_List7():
    delate_pages()
    List1 = ctk.CTkLabel(main_frame, text="Կտորում (Slicing)", font=('Bold', 35))
    List1.pack(pady=100)
    text_content = (
...
def show_List6():
    delate_pages()
    List1 = ctk.CTkLabel(main_frame, text="Ցիկլ ցուցակի վրա", font=('Bold', 35))
    List1.pack(pady=100)
    text_content = (
...
def show_List4():
    delate_pages()
    List1 = ctk.CTkLabel(main_frame, text="Ցուցակի Փոփոխություն", font=('Bold', 35))
    List1.pack(pady=100)
    text_content = (
...
def show_List3():
    delate_pages()
    List1 = ctk.CTkLabel(main_frame, text="Տարրերին մուտք Գործել", font=('Bold', 35))
    List1.pack(pady=100)
    text_content = (
...
def show_List1():
    delate_pages()
    List1 = ctk.CTkLabel(main_frame, text="Ի՞նչ է ցուցակը", font=('Bold', 35))
    List1.pack(pady=100)
    text_content = (
...
def show_List2():
    delate_pages()
    List1 = ctk.CTkLabel(main_frame, text="Ցուցակի ստեղծում", font=('Bold', 35))
    List1.pack(pady=100)
    text_content = (
        "\n# Դատարկ Ցուցակ\n"
        "my_list = []\n\n"
...
def show_Loops_info():
    delate_pages()
    Loops_label = ctk.CTkLabel(main_frame, text="Ցիկլեր", font=('Bold', 35))
...
def show_Loops1():
    delate_pages()
    List1 = ctk.CTkLabel(main_frame, text="for ցիկլ", font=('Bold', 35))
    List1.pack(pady=100)
    text_content = (
...
def show_Loops2():
    delate_pages()
    List1 = ctk.CTkLabel(main_frame, text="while ցիկլ", font=('Bold', 35))
    List1.pack(pady=100)
    text_content = (
...
def show_Loops4():
    delate_pages()
    List1 = ctk.CTkLabel(main_frame, text="Ներդրված ցիկլեր", font=('Bold', 35))
    List1.pack(pady=100)
    text_content = (
...
def show_Loops5():
    delate_pages()
    List1 = ctk.CTkLabel(main_frame, text="Անվերջ ցիկլեր", font=('Bold', 35))
    List1.pack(pady=100)
    text_content = (
...
def show_List_Comprehension_info():
    delate_pages()
    List_Comprehensions_label = ctk.CTkLabel(main_frame, text="List Comprehension", font=('Bold', 35))
    ...
    text_content = (
        ...
        "ան համարժեք ցիկլերը։") 
    List_Comprihation_text = ctk.CTkLabel(main_frame, text=text_content, font=('Bold', 20))
...
def show_List_Comprehension3():
    delate_pages()
    List_Comprehensions_label = ctk.CTkLabel(main_frame, text="Կարևոր Դետալներ", font=('Bold', 35))
    List_Comprehensions_label.pack(pady=100)
    text_content = (
...
def show_List_Comprehension2():
    delate_pages()
    List_Comprehensions_label = ctk.CTkLabel(main_frame, text="Օրինակներ", font=('Bold', 35))
    List_Comprehensions_label.pack(pady=100)
    text_content = (
...
def show_List_Comprehension1():
    delate_pages()
    List_Comprehensions_label = ctk.CTkLabel(main_frame, text="Սինտաքս", font=('Bold', 35))
    List_Comprehensions_label.pack(pady=100)
    text_content = (
...
def show_Nested_Loops_info():
    delate_pages()
    Nested_Loops_label = ctk.CTkLabel(main_frame, text="Ներդրված ցիկլեր", font=('Bold', 35))
...
def show_Nested_Loops2():
    delate_pages()
    List_Comprehensions_label = ctk.CTkLabel(main_frame, text="Հաճախակի կիրառություններ", font=('Bold', 35))
    List_Comprehensions_label.pack(pady=100)
    text_content = (
...
def show_Dictionaries_info():
    delate_pages()
    Dictionaries_label = ctk.CTkLabel(main_frame, text="Dict", font=('Bold', 35))
    ...
    Dictionaries_text = ctk.CTkLabel(main_frame, text=text_content, font=('Bold', 20))
...
def show_Dictionaries4():
    delate_pages()
    List_Comprehensions_label = ctk.CTkLabel(main_frame, text="Կազմությունը (Comprehension)", font=('Bold', 35))
    List_Comprehensions_label.pack(pady=100)
    text_content = (
...
def show_Dictionaries3():
    delate_pages()
    List_Comprehensions_label = ctk.CTkLabel(main_frame, text="Գործողությունները", font=('Bold', 35))
    List_Comprehensions_label.pack(pady=100)
    text_content = (
...
def show_Dictionaries2():
    delate_pages()
    List_Comprehensions_label = ctk.CTkLabel(main_frame, text="Սինտաքսը", font=('Bold', 35))
    List_Comprehensions_label.pack(pady=100)
    text_content = (
        "\n        Ստեղծում ենք Dictionary\n"
        "my_dict = {\n"
...
def show_Dictionaries1():
    delate_pages()
    List_Comprehensions_label = ctk.CTkLabel(main_frame, text="Հիմնական հատկանիշները", font=('Bold', 35))
    List_Comprehensions_label.pack(pady=100)
    text_content = (
...
def show_Functions_info():
    delate_pages()
    Functions_label = ctk.CTkLabel(main_frame, text="Ֆունկցիաներ", font=('Bold', 35))
...
def show_Recursion_info():
    delate_pages()
    Recursion_label = ctk.CTkLabel(main_frame, text="Ռեկուրսիա", font=('Bold', 35))
...
def show_Tuples_and_Sets_info():
    delate_pages()
    Tuples_and_Sets_label = ctk.CTkLabel(main_frame, text="Tuple-ներ և Set-եր", font=('Bold', 35))
...
def show_Lambda_Functions_info():
    delate_pages()
    Lambda_Functions_label = ctk.CTkLabel(main_frame, text="Լամբդա ֆունկցիաներ", font=('Bold', 35))
